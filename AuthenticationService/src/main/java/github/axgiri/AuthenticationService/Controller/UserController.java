...
public class UserController {
    ...
    public ResponseEntity<List<UserRequest>> getByCompanyId(@PathVariable Long id) {
    ...
    @PostMapping("/create")
    public ResponseEntity<AuthResponse> create(@Valid @RequestBody UserRequest userDTO) {
    ...
    public ResponseEntity<UserRequest> update(@RequestBody UserRequest userDTO, @PathVariable Long id) {
